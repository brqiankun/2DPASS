...
label_dir = Path('/home/br/program/2dpass/checkpoint/submit_2023_06_29/sequences/11/predictions') # path to .label data

# label_filter = [40, 48, 70, 72]    # object's label which you wan't to show
label_filter = []
with open('/home/br/program/2dpass/config/label_mapping/semantic-kitti.yaml', 'r') as stream: # label_mapping configuration file
