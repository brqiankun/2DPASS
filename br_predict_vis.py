...
points_dir = Path('/mnt/d/bairui/brfile/dataset/rellis_data/Rellis_3D_lidar_example/Rellis_3D_lidar_example/os1_cloud_node_kitti_bin') # path to .bin data
# label_dir = Path('/home/bairui/program/2dpass/checkpoint/submit_2023_07_07/sequences/11/predictions') # path to .label data
label_dir = Path('/mnt/d/bairui/brfile/dataset/rellis_data/Rellis_3D_lidar_example/Rellis_3D_lidar_example/os1_cloud_node_semantickitti_label_id') # path to .label data
...
with open('/home/bairui/program/2dpass/config/label_mapping/rellis.yaml', 'r') as stream: # label_mapping configuration file
...
for it in label_dir.iterdir():
    ...
    logging.info("\nlabel.shape: {}\npoints.shape: {}\n".format(label.shape, points.shape))
